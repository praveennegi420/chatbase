                ...
                <div className="flex w-full items-center justify-between px-6 pt-6 lg:px-8" aria-label="Global">
                    ...
                    <div className="hidden w-full items-center lg:flex lg:gap-x-12">
                        ...
                        <div className="flex flex-row gap-14">
                            <a target="_blank" className="text-sm font-semibold leading-6 text-gray-900" href="https://affiliates.chatbase.co/signup">Affiliate</a>
                            <a target="_self" className="text-sm font-semibold leading-6 text-gray-900" href="/pricing">Pricing</a>
                            <a target="_blank" className="text-sm font-semibold leading-6 text-gray-900" href="https://docs.chatbase.co/docs">API</a>
                            <a target="_self" className="text-sm font-semibold leading-6 text-gray-900" href="/guide/main">Guide</a>
                        </div>
                        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                            <a className="text-sm font-semibold leading-6 text-gray-900" href="/my-chatbots">Chatbots <span aria-hidden="true">→</span></a>
                        </div>
                    </div>
                </div>
            ...
            <footer className="relative z-30 w-full px-6 bg-zinc-100 text-black">
                <div className="flex flex-row justify-between border-b border-zinc-400 bg-zinc-100 py-12 text-black transition-colors duration-150">
                    <div className="col-span-1 lg:col-span-2 text-slate-800">
                        ...
                        <a className="block text-sm " href="/privacy">Privacy Policy</a>
                        <a className="block text-sm " href="/terms">Terms of Service</a>
                    </div>
                    <div className="col-span-1 flex items-start text-black lg:col-span-6 lg:justify-end">
                        <div className="flex h-10 items-center space-x-6">
                            <a aria-label="LinkedIn Account" target="_blank" href="https://www.linkedin.com/company/chatbase-co">
