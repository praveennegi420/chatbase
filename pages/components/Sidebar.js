                            ...
                            <div className="relative flex h-6 items-center justify-end sm:hidden">
                                <div className="left-100 absolute inset-y-0 flex items-center sm:hidden">
                                    <Link href="/"
                                        ...
                                        id="headlessui-disclosure-Link-:Rall6:"
                                        type="Link"
                                        aria-expanded="false"
                        ...
                        <ul role="list" className="flex flex-1 flex-col">
                            <li>
                                <ul role="list" className="space-y-1">
                                    <li>
                                        <Link href="/" className={router.asPath === '/' ? "bg-gray-50 text-violet-600 group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold leading-6" : "text-gray-700 hover:bg-gray-50 hover:text-violet-600 group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold leading-6"}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                fill="none"
                                                viewBox="0 0 24 24"
                                                ...
                                                stroke="currentColor"
                                                aria-hidden="true"
                                                className={router.asPath === '/' ? "text-violet-600 h-6 w-6 shrink-0" : "text-gray-400 group-hover:text-violet-600 h-6 w-6 shrink-0"}
                                            >
                                    ...
                                    <li>
                                        <Link href="/Text" className={router.asPath === '/Text' ? "bg-gray-50 text-violet-600 group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold leading-6" : "text-gray-700 hover:bg-gray-50 hover:text-violet-600 group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold leading-6"}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                fill="none"
                                                viewBox="0 0 24 24"
                                                ...
                                                stroke="currentColor"
                                                aria-hidden="true"
                                                className={router.asPath === '/Text' ? "text-violet-600 h-6 w-6 shrink-0" : "text-gray-400 group-hover:text-violet-600 h-6 w-6 shrink-0"}
                                            ><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12H12m-8.25 5.25h16.5"></path></svg>
                                            Text
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href="/Website" className={router.asPath === '/Website' ? "bg-gray-50 text-violet-600 group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold leading-6" : "text-gray-700 hover:bg-gray-50 hover:text-violet-600 group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold leading-6"}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                fill="none"
                                                viewBox="0 0 24 24"
                                                ...
                                                stroke="currentColor"
                                                aria-hidden="true"
                                                className={router.asPath === '/Website' ? "text-violet-600 h-6 w-6 shrink-0" : "text-gray-400 group-hover:text-violet-600 h-6 w-6 shrink-0"}
                                            ><path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 013 12c0-1.605.42-3.113 1.157-4.418"></path></svg>
                                            Website
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href="/Qna" className={router.asPath === '/Qna' ? "bg-gray-50 text-violet-600 group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold leading-6" : "text-gray-700 hover:bg-gray-50 hover:text-violet-600 group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold leading-6"}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                fill="none"
                                                viewBox="0 0 24 24"
                                                ...
                                                stroke="currentColor"
                                                aria-hidden="true"
                                                className={router.asPath === '/Qna' ? "text-violet-600 h-6 w-6 shrink-0" : "text-gray-400 group-hover:text-violet-600 h-6 w-6 shrink-0"}
                                    ...
                                    <li>
                                        <Link href="/Notion" className={router.asPath === '/Notion' ? "bg-gray-50 text-violet-600 group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold leading-6" : "text-gray-700 hover:bg-gray-50 hover:text-violet-600 group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold leading-6"}>
                                            <svg viewBox="13.38 3.2 485.44 505.7"
                                                xmlns="http://www.w3.org/2000/svg"
                                                className={router.asPath === '/Notion' ? "text-gray-400 fill-violet-600 text-violet-600 h-6 w-6 shrink-0" : "fill-gray-400 text-gray-400 group-hover:fill-violet-600 group-hover:text-violet-600 h-6 w-6 shrink-0"}
                                                fill="white"
                                                >
